...
public class Rectangle(double x1, double y1, double x2, double y2,
                 double x3, double y3, double x4, double y4) : Shape
{
    ...
    public override double GetArea()
    {
        ...
        double height = Math.Abs(this.y3 - this.y2);
        return width * height;
    }
    ...
    {
        return $"Rectangle: Points ({this.x1},{this.y1}) ({this.x2},{this.y2}) ({this.x3},{this.y3}) ({this.x4},{this.y4})";
    }
}